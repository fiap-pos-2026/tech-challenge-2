...
public interface MechanicalServiceRepository extends JpaRepository<MechanicalService, Long> {
    ...
    @Query("""
            SELECT new br.com.fiap.pos.tech_challenge.core.controller.dto.ServiceAvgDurationResponse(
            ...
            """)
    List<br.com.fiap.pos.tech_challenge.core.controller.dto.ServiceAvgDurationResponse> findAvgDurationByService(
